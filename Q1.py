...
class CohortOutcomes:
    ...
    def get_FIVE_year_OS(self):
        """ returns percentage of patients surviving at the 5-year mark"""
        n = 0
        for i in self._simulatedCohort.get_survival_times():
            if i>5:
                n +=1
        return n/self._simulatedCohort.get_initial_pop_size()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._sumStat_meanFIVEyearOS = None
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store five-year OS for this cohort
            self._FIVE_year_OSs.append(output.get_FIVE_year_OS())
        ...
        self._sumStat_meanFIVEyearOS = Stat.SummaryStat('Mean Five-year OS', self._FIVE_year_OSs)
    ...
    def get_cohort_FIVEyear_OS(self, cohort_index):
        """
        :param cohort_index: index of cohort
        :return: five year OS of a specific cohort
        """
        return self._FIVE_year_OSs[cohort_index]

    def get_all_FIVEyear_OS(self):
        return self._FIVE_year_OSs

    def get_mean_FIVEyear_OS(self):
        return self._sumStat_meanFIVEyearOS.get_mean()
